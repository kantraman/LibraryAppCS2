...
function router(nav) {//Part #2 Point 6
    ...
    booksRouter.post('/delete', function (req, res) {
        ...
        bookdata.findOneAndDelete({ _id: id }, { useFindAndModify: false }) //Part #2 Point 9
            .then(function () {
    ...
    booksRouter.post('/update', function (req, res) {
        bookdata.findOne({ _id: req.body.id }) //Part #2 Point 9
            ...
            .then(function (book) {
                bookdata.findByIdAndUpdate(req.body.id, { $set: book }, { useFindAndModify: false }, //Part #2 Point 9
                    function (err, data) {
                        if (err) {
